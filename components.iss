...
; -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Name: "BepInEx";                               Description: "BepInEx v5.4.23.1 (Plugin framework)"                                                 ; Types: full_en full extra extra_en custom bare; Flags: fixed
...
Name: "FIX\SiH_Tweaks";                        Description: "SiH_Tweaks v1.0.0.0 (Helps fully translate the game and brings some other improvements. You can enable debug mode from Settings > Plugin Settings)"; Types: full_en full extra extra_en

...
TaskDeletePlugins=Delete old plugins (Always recommended. Do not disable unless you know what you are doing)
...
jp.MsgExeNotFound=警告 - ゲームが選択されたディレクトリに見つかりませんでした。 正しく動作させるためには、このパッチをゲームがのメインゲームディレクトリに直接インストールする必要があります。%n%nこのディレクトリが正しいことを確認していますか？
...
jp.TaskDeletePlugins=古いプラグインを削除する（問題がある場合や古いバージョンを更新する場合に推奨）
